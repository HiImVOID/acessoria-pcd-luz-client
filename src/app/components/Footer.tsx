...
export default function Footer() {
    return (
		<footer className='flex w-full bg-gray-500 justify-between'>
			<div className='px-4 py-6 w-full  md:flex md:items-center md:justify-between'>
				<div className='flex flex-col gap-2 items-start'>
					<span className='text-sm text-gray-500 dark:text-gray-300 sm:text-center'>
						© 2023{' '}
						<a href='https://www.bibliotecaocultista.com/'>
							Assessoria PcdLuz™
						</a>
					...
					<span className='text-sm text-gray-500 dark:text-gray-300 sm:text-center'>
						...
						<Link
							...
							target='_blank'
							href={'https://hiimvoid.github.io/raphaelluz/'}>
							Raphael Luz
						</Link>
					</span>
				</div>
				...
				<div className='flex mt-4 space-x-6 sm:justify-center md:mt-0'>
                    ...
                    <a
                        target="_blank"
						href='https://www.instagram.com/pcdluz/'
						className='text-gray-400 hover:text-gray-900 dark:hover:text-white'>
						<svg
							className='w-5 h-5'
							fill='currentColor'
